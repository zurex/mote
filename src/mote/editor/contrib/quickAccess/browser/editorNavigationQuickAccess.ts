...
import { DisposableStore, IDisposable, MutableDisposable, toDisposable } from 'mote/base/common/lifecycle';
import { withNullAsUndefined } from 'mote/base/common/types';
import { getCodeEditor, isDiffEditor } from 'mote/editor/browser/editorBrowser';
import { IRange } from 'mote/editor/common/core/range';
import { IDiffEditor, IEditor, ScrollType } from 'mote/editor/common/editorCommon';
import { IModelDeltaDecoration, ITextModel, OverviewRulerLane } from 'mote/editor/common/model';
import { overviewRulerRangeHighlight } from 'mote/editor/common/core/editorColorRegistry';
import { IQuickAccessProvider } from 'mote/platform/quickinput/common/quickAccess';
import { IKeyMods, IQuickPick, IQuickPickItem } from 'mote/platform/quickinput/common/quickInput';
import { themeColorFromId } from 'mote/platform/theme/common/themeService';
