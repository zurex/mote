...
import { IPreparedQuery, pieceToQuery, prepareQuery, scoreFuzzy2 } from 'mote/base/common/fuzzyScorer';
import { Disposable, DisposableStore, IDisposable, toDisposable } from 'mote/base/common/lifecycle';
import { format, trim } from 'mote/base/common/strings';
import { IRange, Range } from 'mote/editor/common/core/range';
import { ScrollType } from 'mote/editor/common/editorCommon';
import { ITextModel } from 'mote/editor/common/model';
import { DocumentSymbol, SymbolKind, SymbolKinds, SymbolTag } from 'mote/editor/common/languages';
import { IOutlineModelService } from 'mote/editor/contrib/documentSymbols/browser/outlineModel';
import { AbstractEditorNavigationQuickAccessProvider, IEditorNavigationQuickAccessOptions, IQuickAccessTextEditorContext } from 'mote/editor/contrib/quickAccess/browser/editorNavigationQuickAccess';
import { localize } from 'mote/nls';
import { IQuickInputButton, IQuickPick, IQuickPickItem, IQuickPickSeparator } from 'mote/platform/quickinput/common/quickInput';
...
import { findLast } from 'mote/base/common/arrays';
