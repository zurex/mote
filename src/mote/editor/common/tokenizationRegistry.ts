...
import { ITokenizationRegistry, ITokenizationSupport, ITokenizationSupportChangedEvent, ITokenizationSupportFactory } from 'mote/editor/common/languages';
import { ColorId } from 'mote/editor/common/encodedTokenAttributes';
