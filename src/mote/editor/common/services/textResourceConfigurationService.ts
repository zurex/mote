...
import { ITextResourceConfigurationService, ITextResourceConfigurationChangeEvent } from 'mote/editor/common/services/textResourceConfiguration';
import { IConfigurationService, ConfigurationTarget, IConfigurationValue, IConfigurationChangeEvent } from 'mote/platform/configuration/common/configuration';
