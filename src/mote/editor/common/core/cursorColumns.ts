...
export class CursorColumns {
	...
	public static visibleColumnFromColumn(lineContent: string, column: number, tabSize: number): number {
		...
		while (!iterator.eol()) {
			...
			result = this.nextVisibleColumn(codePoint, result, tabSize);
		}
	...
	public static columnFromVisibleColumn(lineContent: string, visibleColumn: number, tabSize: number): number {
		...
		while (!iterator.eol()) {
			...
			const afterVisibleColumn = this.nextVisibleColumn(codePoint, beforeVisibleColumn, tabSize);
	...
	private static nextVisibleColumn(codePoint: number, visibleColumn: number, tabSize: number): number {
