...
import { Token, TokenizationResult, EncodedTokenizationResult, IState } from 'mote/editor/common/languages';
import { LanguageId, FontStyle, ColorId, StandardTokenType, MetadataConsts } from 'mote/editor/common/encodedTokenAttributes';
