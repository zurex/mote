...
import { CharWidthRequest, CharWidthRequestType, readCharWidths } from 'mote/editor/browser/config/charWidthReader';
import { EditorFontLigatures } from 'mote/editor/common/config/editorOptions';
import { BareFontInfo, FontInfo, SERIALIZED_FONT_INFO_VERSION } from 'mote/editor/common/config/fontInfo';
