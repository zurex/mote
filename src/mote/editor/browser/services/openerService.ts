...
import { normalizePath } from 'mote/base/common/resources';
...
import { EditorOpenSource } from 'mote/platform/editor/common/editor';
import { extractSelection, IExternalOpener, IExternalUriResolver, IOpener, IOpenerService, IResolvedExternalUri, IValidator, matchesScheme, matchesSomeScheme, OpenOptions, ResolveExternalUriOptions } from 'mote/platform/opener/common/opener';
...
class EditorOpener implements IOpener {
	...
	constructor(@IMoteEditorService private readonly _editorService: IMoteEditorService) { }
	...
	async open(target: URI | string, options: OpenOptions) {
		...
		await this._editorService.openMoteEditor(
			{
				resource: target,
				options: {
					selection,
...
export class OpenerService implements IOpenerService {
	...
	constructor(
		@IMoteEditorService editorService: IMoteEditorService,
