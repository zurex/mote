...
import { ConfirmResult, IFileDialogService, IDialogService, getFileNamesMessage } from 'mote/platform/dialogs/common/dialogs';
import Severity from 'mote/base/common/severity';
import { WorkbenchState, IWorkspaceContextService } from 'mote/platform/workspace/common/workspace';
...
import { Promises, raceCancellation } from 'mote/base/common/async';
