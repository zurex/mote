...
import { TestNativePathService, TestNativeWindowConfiguration } from 'mote/workbench/test/electron-browser/workbenchTestServices';
import { TestContextService, TestProductService, TestStorageService, TestWorkingCopy } from 'mote/workbench/test/common/workbenchTestServices';
...
import { TestLifecycleService, TestRemoteAgentService, TestWillShutdownEvent } from 'mote/workbench/test/browser/workbenchTestServices';
import { TestConfigurationService } from 'mote/platform/configuration/test/common/testConfigurationService';
import { NativeWorkingCopyHistoryService } from 'mote/workbench/services/workingCopy/electron-sandbox/workingCopyHistoryService';
import { joinPath, dirname as resourcesDirname, basename } from 'mote/base/common/resources';
