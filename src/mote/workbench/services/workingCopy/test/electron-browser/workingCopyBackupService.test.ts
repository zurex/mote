...
import { Promises, readdirSync } from 'mote/base/node/pfs';
...
import { bufferToReadable, bufferToStream, streamToBuffer, VSBuffer, VSBufferReadable, VSBufferReadableStream } from 'mote/base/common/buffer';
import { TestNativeWindowConfiguration } from 'mote/workbench/test/electron-browser/workbenchTestServices';
...
import { consumeStream } from 'mote/base/common/stream';
...
flakySuite('WorkingCopyBackupService', () => {
	...
	suite('resolve', () => {
		...
		test('file with binary data', async () => {
			...
			const sourceDir = FileAccess.asFileUri('mote/workbench/services/workingCopy/test/electron-browser/fixtures').fsPath;
