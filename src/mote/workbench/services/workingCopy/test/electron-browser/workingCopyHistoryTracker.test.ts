...
import { TestWorkingCopyHistoryService } from 'mote/workbench/services/workingCopy/test/electron-browser/workingCopyHistoryService.test';
...
import { basename, dirname, isEqual, joinPath } from 'mote/base/common/resources';
import { TestConfigurationService } from 'mote/platform/configuration/test/common/testConfigurationService';
import { UndoRedoService } from 'mote/platform/undoRedo/common/undoRedoService';
import { TestDialogService } from 'mote/platform/dialogs/test/common/testDialogService';
import { TestNotificationService } from 'mote/platform/notification/test/common/testNotificationService';
