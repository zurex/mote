...
import { NodeTestWorkingCopyBackupService } from 'mote/workbench/services/workingCopy/test/electron-browser/workingCopyBackupService.test';
...
import { HotExitConfiguration } from 'mote/platform/files/common/files';
import { ShutdownReason, ILifecycleService } from 'mote/workbench/services/lifecycle/common/lifecycle';
import { IFileDialogService, ConfirmResult, IDialogService } from 'mote/platform/dialogs/common/dialogs';
...
import { workbenchInstantiationService, TestServiceAccessor } from 'mote/workbench/test/electron-browser/workbenchTestServices';
...
import { createEditorPart, registerTestFileEditor, TestBeforeShutdownEvent, TestFilesConfigurationService } from 'mote/workbench/test/browser/workbenchTestServices';
import { MockContextKeyService } from 'mote/platform/keybinding/test/common/mockKeybindingService';
...
import { TestWorkspace, Workspace } from 'mote/platform/workspace/test/common/testWorkspace';
import { IProgressService } from 'mote/platform/progress/common/progress';
