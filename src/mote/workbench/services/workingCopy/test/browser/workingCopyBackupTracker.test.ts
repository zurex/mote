...
import { createEditorPart, InMemoryTestWorkingCopyBackupService, registerTestResourceEditor, TestServiceAccessor, toTypedWorkingCopyId, toUntypedWorkingCopyId, workbenchInstantiationService } from 'mote/workbench/test/browser/workbenchTestServices';
...
import { bufferToReadable, VSBuffer } from 'mote/base/common/buffer';
import { isWindows } from 'mote/base/common/platform';
import { Schemas } from 'mote/base/common/network';
import { IWorkspaceTrustRequestService } from 'mote/platform/workspace/common/workspaceTrust';
import { TestWorkspaceTrustRequestService } from 'mote/workbench/services/workspaces/test/common/testWorkspaceTrustService';
