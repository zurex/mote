...
import { VSBufferReadableStream, newWriteableBufferStream, VSBuffer, streamToBuffer, bufferToStream, readableToBuffer, VSBufferReadable } from 'mote/base/common/buffer';
...
import { consumeReadable, consumeStream, isReadable, isReadableStream } from 'mote/base/common/stream';
