...
import { ETAG_DISABLED, FileOperationError, FileOperationResult, FileSystemProviderCapabilities, IFileService, IFileStatWithMetadata, IFileStreamContent, IWriteFileOptions, NotModifiedSinceFileOperationError } from 'mote/platform/files/common/files';
...
import { raceCancellation, TaskSequentializer, timeout } from 'mote/base/common/async';
...
import { IAction, toAction } from 'mote/base/common/actions';
...
import { IFileWorkingCopy, IFileWorkingCopyModel, IFileWorkingCopyModelFactory } from 'mote/workbench/services/workingCopy/common/fileWorkingCopy';
