...
import { equals, deepClone } from 'mote/base/common/objects';
...
import { IFileService, FileOperationError, FileOperationResult } from 'mote/platform/files/common/files';
import { ResourceMap } from 'mote/base/common/map';
import { isReadableStream, peekStream } from 'mote/base/common/stream';
import { bufferToStream, prefixedBufferReadable, prefixedBufferStream, readableToBuffer, streamToBuffer, VSBuffer, VSBufferReadable, VSBufferReadableStream } from 'mote/base/common/buffer';
