...
import { Disposable, IDisposable, dispose, toDisposable } from 'mote/base/common/lifecycle';
...
import { AutoSaveMode, IFilesConfigurationService } from 'mote/workbench/services/filesConfiguration/common/filesConfigurationService';
