...
import { Event, AsyncEmitter, IWaitUntil } from 'mote/base/common/event';
...
import { IFileService, FileOperation, IFileStatWithMetadata } from 'mote/platform/files/common/files';
