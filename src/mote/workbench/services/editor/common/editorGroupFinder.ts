...
import { EditorActivation } from 'mote/platform/editor/common/editor';
import { EditorInputCapabilities, EditorInputWithOptions, isEditorInput, isEditorInputWithOptions } from 'mote/workbench/common/editor';
...
function doFindGroup(input: EditorInputWithOptions, preferredGroup: PreferredGroup | undefined, editorGroupService: IEditorGroupsService, configurationService: IConfigurationService): IEditorGroup {
...
function isGroupLockedForEditor(group: IEditorGroup, editor: EditorInput): boolean {
	if (!group.isLocked) {
...
function isActive(group: IEditorGroup, editor: EditorInput): boolean {
...
function isOpened(group: IEditorGroup, editor: EditorInput): boolean {
