...
import 'mote/css!./media/progressService';

import { localize } from 'mote/nls';
import { IDisposable, dispose, DisposableStore, Disposable, toDisposable } from 'mote/base/common/lifecycle';
import { IProgressService, IProgressOptions, IProgressStep, ProgressLocation, IProgress, Progress, IProgressCompositeOptions, IProgressNotificationOptions, IProgressRunner, IProgressIndicator, IProgressWindowOptions, IProgressDialogOptions } from 'mote/platform/progress/common/progress';
...
import { DeferredPromise, RunOnceScheduler, timeout } from 'mote/base/common/async';
import { ProgressBadge, IActivityService } from 'mote/workbench/services/activity/common/activity';
import { INotificationService, Severity, INotificationHandle } from 'mote/platform/notification/common/notification';
...
import { Dialog } from 'mote/base/browser/ui/dialog/dialog';
...
import { IViewsService, IViewDescriptorService, ViewContainerLocation } from 'mote/workbench/common/views';
