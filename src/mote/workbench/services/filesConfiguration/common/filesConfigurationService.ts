...
import { RawContextKey, IContextKey, IContextKeyService } from 'mote/platform/contextkey/common/contextkey';
import { IConfigurationService } from 'mote/platform/configuration/common/configuration';
import { IFilesConfiguration, AutoSaveConfiguration, HotExitConfiguration } from 'mote/platform/files/common/files';
