...
import { IRemoteConnectionData } from 'mote/platform/remote/common/remoteAuthorityResolver';
import { ITelemetryInfo } from 'mote/platform/telemetry/common/telemetry';
