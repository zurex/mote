...
import { IKeymapInfo, IRawMixedKeyboardMapping, KeymapInfo } from 'mote/workbench/services/keybinding/common/keymapInfo';
...
export class BrowserKeyboardLayoutService extends Disposable implements IKeyboardLayoutService {
	...
	private readonly factory: BrowserKeyboardMapperFactory;
	...
	constructor(
		...
		this.factory = new BrowserKeyboardMapperFactory(configurationService);
	}

	getKeyboardMapper(): IKeyboardMapper {
		return this.factory.getKeyboardMapper();
	}
}
