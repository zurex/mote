...
import { isWindows, isLinux } from 'mote/base/common/platform';
import { getKeyboardLayoutId, IKeyboardLayoutInfo } from 'mote/platform/keyboardLayout/common/keyboardLayout';
