...
import { workbenchInstantiationService, TestNativeTextFileServiceWithEncodingOverrides, TestServiceAccessor } from 'mote/workbench/test/electron-browser/workbenchTestServices';
