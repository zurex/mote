...
import { dispose, IDisposable, Disposable, DisposableStore } from 'mote/base/common/lifecycle';
...
import { IFileService, FileChangesEvent, FileOperation, FileChangeType, IFileSystemProviderRegistrationEvent, IFileSystemProviderCapabilitiesChangeEvent } from 'mote/platform/files/common/files';
...
import { ITextSnapshot } from 'mote/editor/common/model';
import { extname, joinPath } from 'mote/base/common/resources';
import { createTextBufferFactoryFromSnapshot } from 'mote/editor/common/model/textModel';
//import { PLAINTEXT_EXTENSION, PLAINTEXT_LANGUAGE_ID } from 'mote/editor/common/languages/modesRegistry';
