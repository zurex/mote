...
import { ReadableStream } from 'mote/base/common/stream';
import { IBaseFileStatWithMetadata, IFileStatWithMetadata, IWriteFileOptions, FileOperationError, FileOperationResult, IReadFileStreamOptions, IFileReadLimits } from 'mote/platform/files/common/files';
import { createDecorator } from 'mote/platform/instantiation/common/instantiation';
import { ITextEditorModel } from 'mote/editor/common/services/resolverService';
import { ITextBufferFactory, ITextModel, ITextSnapshot } from 'mote/editor/common/model';
