...
import { ILabelService, Verbosity } from 'mote/platform/label/common/label';
import { IWorkbenchEnvironmentService } from 'mote/workbench/services/environment/common/environmentService';
import { IWindowOpenable, IOpenWindowOptions, isFolderToOpen, isWorkspaceToOpen, IOpenEmptyWindowOptions } from 'mote/platform/window/common/window';
import { Disposable } from 'mote/base/common/lifecycle';
import { NativeHostService } from 'mote/platform/native/electron-sandbox/nativeHostService';
...
class WorkbenchHostService extends Disposable implements IHostService {
	...
	private getRecentLabel(openable: IWindowOpenable): string {
		...
		return this.labelService.getUriLabel(openable.pageUri);
	}
