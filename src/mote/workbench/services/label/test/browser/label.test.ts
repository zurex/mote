...
import { WorkspaceFolder } from 'mote/platform/workspace/common/workspace';
import { Workspace } from 'mote/platform/workspace/test/common/testWorkspace';
...
import { ResourceLabelFormatter } from 'mote/platform/label/common/label';
