...
import { TestWorkspace } from 'mote/platform/workspace/test/common/testWorkspace';
...
import { TestNativePathService, TestEnvironmentService } from 'mote/workbench/test/electron-browser/workbenchTestServices';
import { TestLifecycleService, TestRemoteAgentService } from 'mote/workbench/test/browser/workbenchTestServices';
