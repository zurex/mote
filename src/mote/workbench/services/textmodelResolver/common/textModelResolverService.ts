import { AsyncReferenceCollection, Disposable, IDisposable, IReference, ReferenceCollection, toDisposable } from 'mote/base/common/lifecycle';
...
import { IResolvedTextEditorModel, isResolvedTextEditorModel, ITextEditorModel, ITextModelContentProvider, ITextModelService } from 'mote/editor/common/services/resolverService';
