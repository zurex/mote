...
import { ExtensionKind, IEnvironmentService, IExtensionHostDebugParams } from 'mote/platform/environment/common/environment';
...
import { parseLineAndColumnAware } from 'mote/base/common/extpath';
...
import { EXTENSION_IDENTIFIER_WITH_LOG_REGEX } from 'mote/platform/environment/common/environmentService';
...
export class BrowserWorkbenchEnvironmentService implements IBrowserWorkbenchEnvironmentService {
	...
	@memoize
	get userRoamingDataHome(): URI { return URI.file('/User').with({ scheme: Schemas.moteUserData }); }
	...
	@memoize
	get pagesToOpenOrCreate(): IPath<ITextEditorOptions>[] | undefined {
		if (this.payload) {
