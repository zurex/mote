...
import { IURLService } from 'mote/platform/url/common/url';
...
import { AbstractURLService } from 'mote/platform/url/common/urlService';
import { Event } from 'mote/base/common/event';
import { IBrowserWorkbenchEnvironmentService } from 'mote/workbench/services/environment/browser/environmentService';
import { IOpenerService, IOpener, OpenExternalOptions, OpenInternalOptions, matchesScheme } from 'mote/platform/opener/common/opener';
...
export interface IURLCallbackProvider {
	 ...
	 *
	 * For example: if a Uri is to be created with `scheme:"mote"`,
	 * `authority:"foo"` and `path:"bar"` the `onCallback` should fire
	 * with a Uri `mote://foo/bar`.
	 *
