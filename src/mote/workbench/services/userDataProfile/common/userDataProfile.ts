...
import { IUserDataProfile, IUserDataProfileOptions, IUserDataProfileUpdateOptions } from 'mote/platform/userDataProfile/common/userDataProfile';
...
import { ITreeItem, ITreeItemCheckboxState, ITreeItemLabel } from 'mote/workbench/common/views';
