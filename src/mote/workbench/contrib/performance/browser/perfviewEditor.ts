...
import { ITextModelService, ITextModelContentProvider } from 'mote/editor/common/services/resolverService';
...
import { LoaderStats } from 'mote/base/common/amd';
...
import { ByteSize, IFileService } from 'mote/platform/files/common/files';
...
class PerfModelContentProvider implements ITextModelContentProvider {
	...
	constructor(
		...
		@IMoteEditorService private readonly _editorService: IMoteEditorService,
