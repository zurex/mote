...
import { ICommandQuickPick, CommandsHistory } from 'mote/platform/quickinput/browser/commandsQuickAccess';
import { IEditorService } from 'mote/workbench/services/editor/common/editorService';
import { IMenuService, MenuId, MenuItemAction, SubmenuItemAction, Action2 } from 'mote/platform/actions/common/actions';
import { CancellationToken } from 'mote/base/common/cancellation';
import { AbstractEditorCommandsQuickAccessProvider } from 'mote/editor/contrib/quickAccess/browser/commandsQuickAccess';
import { IEditor } from 'mote/editor/common/editorCommon';
import { Language } from 'mote/base/common/platform';
...
import { DefaultQuickAccessFilterValue } from 'mote/platform/quickinput/common/quickAccess';
...
import { TriggerAction } from 'mote/platform/quickinput/browser/pickerQuickAccess';
...
export class CommandsQuickAccessProvider extends AbstractEditorCommandsQuickAccessProvider {
	...
	*/
	...
	protected get activeTextEditorControl(): IEditor | undefined { return this.editorService.activeEditorControl; }
	...
	protected async getCommandPicks(token: CancellationToken): Promise<Array<ICommandQuickPick>> {
		...
		return [
			...this.getMoteEditorCommandPicks(),
			...
			trigger: (): TriggerAction => {
				//TODO: this.preferencesService.openGlobalKeybindingSettings(false, { query: `@command:${c.commandId}` });
