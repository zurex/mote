...
import { $, addDisposableListener, append, EventType, hide, show } from 'mote/base/browser/dom';
...
import { isMacintosh, isWindows, isLinux, isNative } from 'mote/base/common/platform';
import { MenuId } from 'mote/platform/actions/common/actions';
import { TitlebarPart as BrowserTitleBarPart } from 'mote/workbench/browser/parts/titlebar/titlebarPart';
...
import { getTitleBarStyle, useWindowControlsOverlay } from 'mote/platform/window/common/window';
