...
export class EditorGroupModel extends Disposable {
	...
	contains(candidate: EditorInput, options?: IMatchEditorOptions): boolean {
	...
	private matches(editor: EditorInput | null, candidate: EditorInput | null, options?: IMatchEditorOptions): boolean {
		if (!editor || !candidate) {
			return false;
		}
