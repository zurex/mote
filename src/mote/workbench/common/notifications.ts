...
import { INotification, INotificationHandle, INotificationActions, INotificationProgress, NoOpNotification, Severity, NotificationMessage, IPromptChoice, IStatusMessageOptions, NotificationsFilter, INotificationProgressProperties, IPromptChoiceWithMenu } from 'mote/platform/notification/common/notification';
import { toErrorMessage, isErrorWithActions } from 'mote/base/common/errorMessage';
...
import { parseLinkedText, LinkedText } from 'mote/base/common/linkedText';
