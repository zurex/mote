import { dirname, isEqual } from 'mote/base/common/resources';
import { URI } from 'mote/base/common/uri';
import { FileSystemProviderCapabilities, IFileService } from 'mote/platform/files/common/files';
import { ILabelService } from 'mote/platform/label/common/label';
import { EditorInputCapabilities, EditorInputWithPreferredResource, Verbosity } from 'mote/workbench/common/editor';
