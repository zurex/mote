...
import { setupCustomHover } from 'mote/base/browser/ui/iconLabel/iconLabelHover';
import { renderIcon } from 'mote/base/browser/ui/iconLabel/iconLabels';
...
import { HiddenItemStrategy, MenuWorkbenchToolBar } from 'mote/platform/actions/browser/toolbar';
import { MenuId, MenuItemAction } from 'mote/platform/actions/common/actions';
...
import * as colors from 'mote/platform/theme/common/colorRegistry';
import { WindowTitle } from 'mote/workbench/browser/parts/titlebar/windowTitle';
import { MENUBAR_SELECTION_BACKGROUND, MENUBAR_SELECTION_FOREGROUND, TITLE_BAR_ACTIVE_FOREGROUND, TITLE_BAR_INACTIVE_FOREGROUND } from 'mote/workbench/common/theme';
