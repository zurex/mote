...
import { dirname, basename } from 'mote/base/common/resources';
import { ITitleProperties } from 'mote/workbench/services/title/common/titleService';
import { IConfigurationService, IConfigurationChangeEvent } from 'mote/platform/configuration/common/configuration';
...
import { IWorkspaceContextService, WorkbenchState, IWorkspaceFolder } from 'mote/platform/workspace/common/workspace';
import { isWindows, isWeb } from 'mote/base/common/platform';
import { URI } from 'mote/base/common/uri';
import { trim } from 'mote/base/common/strings';
import { IInstantiationService } from 'mote/platform/instantiation/common/instantiation';
import { template } from 'mote/base/common/labels';
import { ILabelService, Verbosity as LabelVerbosity } from 'mote/platform/label/common/label';
...
import { getVirtualWorkspaceLocation } from 'mote/platform/workspace/common/virtualWorkspace';
