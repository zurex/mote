...
import { Disposable, MutableDisposable } from 'mote/base/common/lifecycle';
import { SimpleIconLabel } from 'mote/base/browser/ui/iconLabel/simpleIconLabel';
import { ICommandService } from 'mote/platform/commands/common/commands';
import { IStatusbarEntry, ShowTooltipCommand } from 'mote/workbench/services/statusbar/browser/statusbar';
import { IThemeService } from 'mote/platform/theme/common/themeService';
import { ThemeColor } from 'mote/base/common/themables';
import { isThemeColor } from 'mote/editor/common/editorCommon';
import { addDisposableListener, EventType, hide, show, append, EventHelper } from 'mote/base/browser/dom';
...
import { renderIcon, renderLabelWithIcons } from 'mote/base/browser/ui/iconLabel/iconLabels';
import { spinningLoading, syncing } from 'mote/platform/theme/common/iconRegistry';
import { ICustomHover, setupCustomHover } from 'mote/base/browser/ui/iconLabel/iconLabelHover';
import { isMarkdownString, markdownStringEqual } from 'mote/base/common/htmlContent';
