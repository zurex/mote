...
import { ISocket, SocketCloseEvent, SocketCloseEventType, SocketDiagnostics, SocketDiagnosticsEventType } from 'mote/base/parts/ipc/common/ipc.net';
import { IConnectCallback, ISocketFactory } from 'mote/platform/remote/common/remoteAgentConnection';
