...
import { DidChangeLoggersEvent, ILoggerResource, ILoggerService, LogLevel, isLogLevel } from 'mote/platform/log/common/log';
import { LoggerService } from 'mote/platform/log/node/loggerService';
