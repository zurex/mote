...
import { OPTIONS, parseArgs } from 'mote/platform/environment/node/argv';
...
import { IS_NEW_KEY, StorageScope } from 'mote/platform/storage/common/storage';
import { IStorageChangeEvent, IStorageMain, IStorageMainOptions } from 'mote/platform/storage/electron-main/storageMain';
import { StorageMainService } from 'mote/platform/storage/electron-main/storageMainService';
import { currentSessionDateStorageKey, firstSessionDateStorageKey } from 'mote/platform/telemetry/common/telemetry';
...
import { TestLifecycleMainService } from 'mote/platform/test/electron-main/workbenchTestServices';
