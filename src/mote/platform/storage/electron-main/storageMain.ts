...
import { top } from 'mote/base/common/arrays';
...
import { InMemoryStorageDatabase, IStorage, Storage, StorageHint, StorageState } from 'mote/base/parts/storage/common/storage';
import { ISQLiteStorageDatabaseLoggingOptions, SQLiteStorageDatabase } from 'mote/base/parts/storage/node/storage';
...
import { IS_NEW_KEY } from 'mote/platform/storage/common/storage';
import { IUserDataProfile, IUserDataProfilesService } from 'mote/platform/userDataProfile/common/userDataProfile';
import { currentSessionDateStorageKey, firstSessionDateStorageKey, lastSessionDateStorageKey } from 'mote/platform/telemetry/common/telemetry';
import { isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IAnyWorkspaceIdentifier } from 'mote/platform/workspace/common/workspace';
