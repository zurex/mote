...
import { IBaseSerializableStorageRequest, ISerializableItemsChangeEvent, ISerializableUpdateRequest, Key, Value } from 'mote/platform/storage/common/storageIpc';
import { IStorageChangeEvent, IStorageMain } from 'mote/platform/storage/electron-main/storageMain';
...
import { reviveIdentifier, IAnyWorkspaceIdentifier } from 'mote/platform/workspace/common/workspace';
