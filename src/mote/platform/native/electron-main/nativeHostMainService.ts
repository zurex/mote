...
import { mnemonicButtonLabel } from 'mote/base/common/labels';
import { Disposable } from 'mote/base/common/lifecycle';
import { Schemas } from 'mote/base/common/network';
import { dirname, join, resolve } from 'mote/base/common/path';
import { isLinux, isLinuxSnap, isMacintosh, isWindows } from 'mote/base/common/platform';
import { AddFirstParameterToFunctions } from 'mote/base/common/types';
import { URI } from 'mote/base/common/uri';
import { realpath } from 'mote/base/node/extpath';
import { virtualMachineHint } from 'mote/base/node/id';
import { Promises, SymlinkSupport } from 'mote/base/node/pfs';
import { findFreePort } from 'mote/base/node/ports';
import { MouseInputEvent } from 'mote/base/parts/sandbox/common/electronTypes';
import { localize } from 'mote/nls';
import { ISerializableCommandAction } from 'mote/platform/action/common/action';
import { INativeOpenDialogOptions } from 'mote/platform/dialogs/common/dialogs';
...
import { ICommonNativeHostService, IOSProperties, IOSStatistics } from 'mote/platform/native/common/native';
import { IProductService } from 'mote/platform/product/common/productService';
import { ISharedProcess } from 'mote/platform/sharedProcess/node/sharedProcess';
...
export class NativeHostMainService extends Disposable implements INativeHostMainService {
	...
	private windowById(windowId: number | undefined): IAppWindow | undefined {
