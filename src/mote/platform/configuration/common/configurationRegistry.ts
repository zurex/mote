...
export const resourceLanguageSettingsSchemaId = 'mote://schemas/settings/resourceLanguage';
export const configurationDefaultsSchemaId = 'mote://schemas/settings/configurationDefaults';
...
Registry.add(ConfigurationExtensions.Configuration, configurationRegistry);
