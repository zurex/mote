...
import { IInputBox, IInputOptions, IKeyMods, IPickOptions, IQuickInputButton, IQuickNavigateConfiguration, IQuickPick, IQuickPickItem, QuickPickInput } from 'mote/base/parts/quickinput/common/quickInput';
import { createDecorator } from 'mote/platform/instantiation/common/instantiation';
import { IQuickAccessController } from 'mote/platform/quickinput/common/quickAccess';

export * from 'mote/base/parts/quickinput/common/quickInput';
