...
import { IKeyMods, IQuickPickDidAcceptEvent, IQuickPickSeparator } from 'mote/base/parts/quickinput/common/quickInput';
import { IQuickAccessProvider, IQuickAccessProviderRunOptions } from 'mote/platform/quickinput/common/quickAccess';
