...
import { getClientArea, getTopLeftOffset } from 'mote/base/browser/dom';
import { coalesce } from 'mote/base/common/arrays';
import { language, locale } from 'mote/base/common/platform';
import { IElement, ILocaleInfo, ILocalizedStrings, IWindowDriver } from 'mote/platform/driver/common/driver';
import localizedStrings from 'mote/platform/languagePacks/common/localizedStrings';
