...
import { consumeStream, newWriteableStream, ReadableStreamEvents } from 'mote/base/common/stream';
import { URI } from 'mote/base/common/uri';
import { IFileOpenOptions, IFileReadStreamOptions, FileSystemProviderCapabilities, FileType, IFileSystemProviderCapabilitiesChangeEvent, IFileSystemProviderRegistrationEvent, IStat } from 'mote/platform/files/common/files';
import { FileService } from 'mote/platform/files/common/fileService';
import { NullFileSystemProvider } from 'mote/platform/files/test/common/nullFileSystemProvider';
