...
import { URI as uri } from 'mote/base/common/uri';
import { FileChangesEvent, FileChangeType, IFileChange } from 'mote/platform/files/common/files';
import { IDiskFileChange, coalesceEvents, toFileChanges, parseWatcherPatterns } from 'mote/platform/files/common/watcher';
