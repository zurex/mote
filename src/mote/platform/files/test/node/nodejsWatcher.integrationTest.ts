...
import { basename, dirname, join } from 'mote/base/common/path';
import { Promises, RimRafMode } from 'mote/base/node/pfs';
...
import { INonRecursiveWatchRequest } from 'mote/platform/files/common/watcher';
import { NodeJSFileWatcherLibrary, watchFileContents } from 'mote/platform/files/node/watcher/nodejs/nodejsWatcherLib';
import { isLinux, isMacintosh, isWindows } from 'mote/base/common/platform';
import { getDriveLetter } from 'mote/base/common/extpath';
