...
import { Barrier, retry } from 'mote/base/common/async';
...
import { isEqual } from 'mote/base/common/extpath';
import { DisposableStore, IDisposable, toDisposable } from 'mote/base/common/lifecycle';
import { basename, dirname } from 'mote/base/common/path';
import { isLinux, isWindows } from 'mote/base/common/platform';
import { extUriBiasedIgnorePathCase, joinPath } from 'mote/base/common/resources';
import { newWriteableStream, ReadableStreamEvents } from 'mote/base/common/stream';
import { URI } from 'mote/base/common/uri';
import { IDirent, Promises, RimRafMode, SymlinkSupport } from 'mote/base/node/pfs';
import { localize } from 'mote/nls';
import { createFileSystemProviderError, IFileAtomicReadOptions, IFileDeleteOptions, IFileOpenOptions, IFileOverwriteOptions, IFileReadStreamOptions, FileSystemProviderCapabilities, FileSystemProviderError, FileSystemProviderErrorCode, FileType, IFileWriteOptions, IFileSystemProviderWithFileAtomicReadCapability, IFileSystemProviderWithFileCloneCapability, IFileSystemProviderWithFileFolderCopyCapability, IFileSystemProviderWithFileReadStreamCapability, IFileSystemProviderWithFileReadWriteCapability, IFileSystemProviderWithOpenReadWriteCloseCapability, isFileOpenForWriteOptions, IStat } from 'mote/platform/files/common/files';
import { readFileIntoStream } from 'mote/platform/files/common/io';
import { AbstractNonRecursiveWatcherClient, AbstractUniversalWatcherClient, IDiskFileChange, ILogMessage } from 'mote/platform/files/common/watcher';
import { ILogService } from 'mote/platform/log/common/log';
import { AbstractDiskFileSystemProvider, IDiskFileSystemProviderOptions } from 'mote/platform/files/common/diskFileSystemProvider';
import { toErrorMessage } from 'mote/base/common/errorMessage';
import { UniversalWatcherClient } from 'mote/platform/files/node/watcher/watcherClient';
import { NodeJSWatcherClient } from 'mote/platform/files/node/watcher/nodejs/nodejsClient';
