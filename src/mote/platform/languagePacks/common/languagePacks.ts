...
import { IQuickPickItem } from 'mote/base/parts/quickinput/common/quickInput';
import { localize } from 'mote/nls';
import { IExtensionGalleryService, IGalleryExtension } from 'mote/platform/extensionManagement/common/extensionManagement';
