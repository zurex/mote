...
import { IExtensionGalleryService } from 'mote/platform/extensionManagement/common/extensionManagement';
import { IExtensionResourceLoaderService } from 'mote/platform/extensionResourceLoader/common/extensionResourceLoader';
