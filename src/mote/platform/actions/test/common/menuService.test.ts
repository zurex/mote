...
import { isIMenuItem, MenuId, MenuRegistry } from 'mote/platform/actions/common/actions';
import { MenuService } from 'mote/platform/actions/common/menuService';
import { NullCommandService } from 'mote/platform/commands/test/common/nullCommandService';
import { MockContextKeyService } from 'mote/platform/keybinding/test/common/mockKeybindingService';
import { InMemoryStorageService } from 'mote/platform/storage/common/storage';
