...
import { MenuEntryActionViewItem } from 'mote/platform/actions/browser/menuEntryActionViewItem';
import { MenuItemAction } from 'mote/platform/actions/common/actions';
