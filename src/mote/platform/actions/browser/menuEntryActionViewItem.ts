...
import { $, addDisposableListener, append, asCSSUrl, EventType, ModifierKeyEmitter, prepend } from 'mote/base/browser/dom';
import { StandardKeyboardEvent } from 'mote/base/browser/keyboardEvent';
import { ActionViewItem, BaseActionViewItem, SelectActionViewItem } from 'mote/base/browser/ui/actionbar/actionViewItems';
import { DropdownMenuActionViewItem, IDropdownMenuActionViewItemOptions } from 'mote/base/browser/ui/dropdown/dropdownActionViewItem';
import { ActionRunner, IAction, IRunEvent, Separator, SubmenuAction } from 'mote/base/common/actions';
import { Event } from 'mote/base/common/event';
import { UILabelProvider } from 'mote/base/common/keybindingLabels';
import { KeyCode } from 'mote/base/common/keyCodes';
import { combinedDisposable, MutableDisposable, toDisposable } from 'mote/base/common/lifecycle';
import { isLinux, isWindows, OS } from 'mote/base/common/platform';
import 'mote/css!./menuEntryActionViewItem';
import { localize } from 'mote/nls';
import { IMenu, IMenuActionOptions, IMenuService, MenuItemAction, SubmenuItemAction } from 'mote/platform/actions/common/actions';
import { ICommandAction, isICommandActionToggleInfo } from 'mote/platform/action/common/action';
