...
import { IToolBarOptions, ToolBar } from 'mote/base/browser/ui/toolbar/toolbar';
import { IAction, Separator, SubmenuAction, toAction, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent } from 'mote/base/common/actions';
import { coalesceInPlace } from 'mote/base/common/arrays';
import { BugIndicatingError } from 'mote/base/common/errors';
import { DisposableStore } from 'mote/base/common/lifecycle';
import { localize } from 'mote/nls';
import { createAndFillInActionBarActions } from 'mote/platform/actions/browser/menuEntryActionViewItem';
import { IMenuActionOptions, IMenuService, MenuId, MenuItemAction, SubmenuItemAction } from 'mote/platform/actions/common/actions';
