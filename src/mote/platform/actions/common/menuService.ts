...
import { DebounceEmitter, Emitter, Event } from 'mote/base/common/event';
import { DisposableStore } from 'mote/base/common/lifecycle';
import { IMenu, IMenuActionOptions, IMenuChangeEvent, IMenuCreateOptions, IMenuItem, IMenuItemHide, IMenuService, isIMenuItem, isISubmenuItem, ISubmenuItem, MenuId, MenuItemAction, MenuRegistry, SubmenuItemAction } from 'mote/platform/actions/common/actions';
import { ICommandAction, ILocalizedString } from 'mote/platform/action/common/action';
import { ICommandService } from 'mote/platform/commands/common/commands';
import { ContextKeyExpression, IContextKeyService } from 'mote/platform/contextkey/common/contextkey';
...
import { removeFastWithoutKeepingOrder } from 'mote/base/common/arrays';
