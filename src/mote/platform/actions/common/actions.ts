...
import { Action, IAction, SubmenuAction } from 'mote/base/common/actions';
import { ThemeIcon } from 'mote/base/common/themables';
import { Event, MicrotaskEmitter } from 'mote/base/common/event';
...
import { ICommandAction, ICommandActionTitle, Icon, ILocalizedString } from 'mote/platform/action/common/action';
import { Categories } from 'mote/platform/action/common/actionCommonCategories';
import { CommandsRegistry, ICommandHandlerDescription, ICommandService } from 'mote/platform/commands/common/commands';
...
import { BrandedService, createDecorator, IConstructorSignature, ServicesAccessor } from 'mote/platform/instantiation/common/instantiation';
import { IKeybindingRule, IKeybindings, KeybindingsRegistry } from 'mote/platform/keybinding/common/keybindingsRegistry';
