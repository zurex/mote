...
import { parse } from 'mote/base/common/json';
import { Disposable } from 'mote/base/common/lifecycle';
import { Schemas } from 'mote/base/common/network';
import { dirname, join } from 'mote/base/common/path';
import { basename, extUriBiasedIgnorePathCase, joinPath, originalFSPath } from 'mote/base/common/resources';
import { withNullAsUndefined } from 'mote/base/common/types';
import { URI } from 'mote/base/common/uri';
import { Promises } from 'mote/base/node/pfs';
import { localize } from 'mote/nls';
import { IBackupMainService } from 'mote/platform/backup/electron-main/backup';
...
import { IUserDataProfilesMainService } from 'mote/platform/userDataProfile/electron-main/userDataProfile';
import { ICodeWindow } from 'mote/platform/window/electron-main/window';
import { findWindowOnWorkspaceOrFolder } from 'mote/platform/windows/electron-main/windowsFinder';
import { isWorkspaceIdentifier, IWorkspaceIdentifier, IResolvedWorkspace, hasWorkspaceFileExtension, UNTITLED_WORKSPACE_NAME, isUntitledWorkspace } from 'mote/platform/workspace/common/workspace';
import { getStoredWorkspaceFolder, IEnterWorkspaceResult, isStoredWorkspaceFolder, IStoredWorkspace, IStoredWorkspaceFolder, IUntitledWorkspaceInfo, IWorkspaceFolderCreationData, toWorkspaceFolders } from 'mote/platform/workspaces/common/workspaces';
import { getWorkspaceIdentifier } from 'mote/platform/workspaces/node/workspaces';
