...
import { Emitter, Event as CommonEvent } from 'mote/base/common/event';
import { normalizeDriveLetter, splitName } from 'mote/base/common/labels';
import { Disposable } from 'mote/base/common/lifecycle';
import { Schemas } from 'mote/base/common/network';
import { isMacintosh, isWindows } from 'mote/base/common/platform';
import { basename, extUriBiasedIgnorePathCase, originalFSPath } from 'mote/base/common/resources';
...
import { IApplicationStorageMainService } from 'mote/platform/storage/electron-main/storageMainService';
import { IRecent, IRecentFile, IRecentFolder, IRecentlyOpened, IRecentWorkspace, isRecentFile, isRecentFolder, isRecentWorkspace, restoreRecentlyOpened, toStoreData } from 'mote/platform/workspaces/common/workspaces';
import { IWorkspaceIdentifier, WORKSPACE_EXTENSION } from 'mote/platform/workspace/common/workspace';
