...
import { dirname, join, normalize, resolve } from 'mote/base/common/path';
...
import { ExtensionKind, IDebugParams, IExtensionHostDebugParams, INativeEnvironmentService } from 'mote/platform/environment/common/environment';
