...
import { IFileService, FileSystemProviderCapabilities, IFileSystemProviderCapabilitiesChangeEvent, IFileSystemProviderRegistrationEvent } from 'mote/platform/files/common/files';
import { ExtUri, IExtUri, normalizePath } from 'mote/base/common/resources';
import { SkipList } from 'mote/base/common/skipList';
