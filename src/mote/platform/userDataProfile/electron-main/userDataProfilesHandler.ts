...
import { ICodeWindow, LoadReason } from 'mote/platform/window/electron-main/window';
import { IUserDataProfilesMainService } from 'mote/platform/userDataProfile/electron-main/userDataProfile';
import { IAnyWorkspaceIdentifier, isEmptyWorkspaceIdentifier, toWorkspaceIdentifier } from 'mote/platform/workspace/common/workspace';
