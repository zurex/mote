...
import { IServerChannel } from 'mote/base/parts/ipc/common/ipc';
import { ILogService } from 'mote/platform/log/common/log';
import { IProfileStorageChanges, IProfileStorageValueChanges } from 'mote/platform/userDataProfile/common/userDataProfileStorageService';
import { loadKeyTargets, StorageScope, TARGET_KEY } from 'mote/platform/storage/common/storage';
import { IBaseSerializableStorageRequest } from 'mote/platform/storage/common/storageIpc';
import { IStorageMain } from 'mote/platform/storage/electron-main/storageMain';
import { IStorageMainService } from 'mote/platform/storage/electron-main/storageMainService';
