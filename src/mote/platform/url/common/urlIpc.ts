...
import { Client, IChannel, IClientRouter, IConnectionHub, IServerChannel } from 'mote/base/parts/ipc/common/ipc';
import { IOpenURLOptions, IURLHandler } from 'mote/platform/url/common/url';
