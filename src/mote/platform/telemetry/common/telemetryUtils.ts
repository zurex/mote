...
import { cloneAndChange, safeStringify } from 'mote/base/common/objects';
import { isObject } from 'mote/base/common/types';
import { Event } from 'mote/base/common/event';
import { URI } from 'mote/base/common/uri';
import { ConfigurationTarget, ConfigurationTargetToString, IConfigurationService } from 'mote/platform/configuration/common/configuration';
...
import { getRemoteName } from 'mote/platform/remote/common/remoteHosts';
import { verifyMicrosoftInternalDomain } from 'mote/platform/telemetry/common/commonProperties';
import { ClassifiedEvent, IGDPRProperty, OmitMetadata, StrictPropertyCheck } from 'mote/platform/telemetry/common/gdprTypings';
import { ICustomEndpointTelemetryService, ITelemetryData, ITelemetryEndpoint, ITelemetryInfo, ITelemetryService, TelemetryConfiguration, TelemetryLevel, TELEMETRY_CRASH_REPORTER_SETTING_ID, TELEMETRY_OLD_SETTING_ID, TELEMETRY_SETTING_ID } from 'mote/platform/telemetry/common/telemetry';
