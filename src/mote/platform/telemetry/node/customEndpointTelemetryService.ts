...
import { Client as TelemetryClient } from 'mote/base/parts/ipc/node/ipc.cp';
...
import { ILogService, ILoggerService } from 'mote/platform/log/common/log';
import { IProductService } from 'mote/platform/product/common/productService';
import { ICustomEndpointTelemetryService, ITelemetryData, ITelemetryEndpoint, ITelemetryService } from 'mote/platform/telemetry/common/telemetry';
import { TelemetryAppenderClient } from 'mote/platform/telemetry/common/telemetryIpc';
			...
			const client = new TelemetryClient(
				FileAccess.asFileUri('bootstrap-fork').fsPath,
				{
					...
					env: {
						...
						VSCODE_AMD_ENTRYPOINT: 'mote/workbench/contrib/debug/node/telemetryApp'
					}
				}
			);
