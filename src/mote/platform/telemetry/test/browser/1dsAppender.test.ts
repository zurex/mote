...
import { OneDataSystemWebAppender } from 'mote/platform/telemetry/browser/1dsAppender';
import { IAppInsightsCore } from 'mote/platform/telemetry/common/1dsAppender';
