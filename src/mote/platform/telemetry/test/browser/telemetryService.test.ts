...
import ErrorTelemetry from 'mote/platform/telemetry/browser/errorTelemetry';
import { ClassifiedEvent, IGDPRProperty, OmitMetadata, StrictPropertyCheck } from 'mote/platform/telemetry/common/gdprTypings';
import { ITelemetryData, TelemetryConfiguration, TelemetryLevel } from 'mote/platform/telemetry/common/telemetry';
import { ITelemetryServiceConfig, TelemetryService } from 'mote/platform/telemetry/common/telemetryService';
import { ITelemetryAppender, NullAppender } from 'mote/platform/telemetry/common/telemetryUtils';
