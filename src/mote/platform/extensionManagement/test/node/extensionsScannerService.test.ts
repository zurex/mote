...
import { IExtensionsProfileScannerService, IProfileExtensionsScanOptions } from 'mote/platform/extensionManagement/common/extensionsProfileScannerService';
import { AbstractExtensionsScannerService, ExtensionScannerInput, IExtensionsScannerService, IScannedExtensionManifest, Translations } from 'mote/platform/extensionManagement/common/extensionsScannerService';
import { ExtensionsProfileScannerService } from 'mote/platform/extensionManagement/node/extensionsProfileScannerService';
import { ExtensionType, IExtensionManifest, MANIFEST_CACHE_FOLDER, TargetPlatform } from 'mote/platform/extensions/common/extensions';
...
import { IUserDataProfilesService, UserDataProfilesService } from 'mote/platform/userDataProfile/common/userDataProfile';
