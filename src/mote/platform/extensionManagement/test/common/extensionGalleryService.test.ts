...
import { isUUID } from 'mote/base/common/uuid';
...
import { IRawGalleryExtensionVersion, sortExtensionVersions } from 'mote/platform/extensionManagement/common/extensionGalleryService';
...
import { TelemetryConfiguration, TELEMETRY_SETTING_ID } from 'mote/platform/telemetry/common/telemetry';
import { TargetPlatform } from 'mote/platform/extensions/common/extensions';
