...
import { Promises as FSPromises } from 'mote/base/node/pfs';
...
import { ExtensionManagementError, ExtensionManagementErrorCode, IExtensionGalleryService, IGalleryExtension, InstallOperation } from 'mote/platform/extensionManagement/common/extensionManagement';
import { ExtensionKey, groupByExtension } from 'mote/platform/extensionManagement/common/extensionManagementUtil';
import { ExtensionSignatureVerificationError, IExtensionSignatureVerificationService } from 'mote/platform/extensionManagement/node/extensionSignatureVerificationService';
import { IFileService, IFileStatWithMetadata } from 'mote/platform/files/common/files';
