...
import { Promises, Queue } from 'mote/base/common/async';
...
import { ResourceSet } from 'mote/base/common/map';
import { Schemas } from 'mote/base/common/network';
import * as path from 'mote/base/common/path';
import { isMacintosh, isWindows } from 'mote/base/common/platform';
import { joinPath } from 'mote/base/common/resources';
import * as semver from 'mote/base/common/semver/semver';
import { isBoolean, isUndefined } from 'mote/base/common/types';
import { URI } from 'mote/base/common/uri';
import { generateUuid } from 'mote/base/common/uuid';
import * as pfs from 'mote/base/node/pfs';
import { extract, ExtractError, IFile, zip } from 'mote/base/node/zip';
...
import { AbstractExtensionManagementService, AbstractExtensionTask, ExtensionVerificationStatus, IInstallExtensionTask, InstallExtensionTaskOptions, IUninstallExtensionTask, joinErrors, UninstallExtensionTaskOptions } from 'mote/platform/extensionManagement/common/abstractExtensionManagementService';
import {
...
} from 'mote/platform/extensionManagement/common/extensionManagement';
import { areSameExtensions, computeTargetPlatform, ExtensionKey, getGalleryExtensionId, groupByExtension } from 'mote/platform/extensionManagement/common/extensionManagementUtil';
import { IExtensionsProfileScannerService } from 'mote/platform/extensionManagement/common/extensionsProfileScannerService';
import { IExtensionsScannerService, IScannedExtension, ScanOptions } from 'mote/platform/extensionManagement/common/extensionsScannerService';
import { ExtensionsDownloader } from 'mote/platform/extensionManagement/node/extensionDownloader';
import { ExtensionsLifecycle } from 'mote/platform/extensionManagement/node/extensionLifecycle';
import { getManifest } from 'mote/platform/extensionManagement/node/extensionManagementUtil';
import { ExtensionsManifestCache } from 'mote/platform/extensionManagement/node/extensionsManifestCache';
import { DidChangeProfileExtensionsEvent, ExtensionsWatcher } from 'mote/platform/extensionManagement/node/extensionsWatcher';
import { ExtensionType, IExtension, IExtensionManifest, isApplicationScopedExtension, TargetPlatform } from 'mote/platform/extensions/common/extensions';
import { isEngineValid } from 'mote/platform/extensions/common/extensionValidator';
import { FileChangesEvent, FileChangeType, IFileService } from 'mote/platform/files/common/files';
import { IInstantiationService, refineServiceDecorator } from 'mote/platform/instantiation/common/instantiation';
