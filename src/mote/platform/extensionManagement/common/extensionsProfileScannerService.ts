...
import { IExtension, IExtensionIdentifier, isIExtensionIdentifier } from 'mote/platform/extensions/common/extensions';
...
import { Mutable, isObject, isString } from 'mote/base/common/types';
