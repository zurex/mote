...
import { distinct, isNonEmptyArray } from 'mote/base/common/arrays';
import { Barrier, CancelablePromise, createCancelablePromise } from 'mote/base/common/async';
import { CancellationToken } from 'mote/base/common/cancellation';
import { CancellationError, getErrorMessage } from 'mote/base/common/errors';
...
import { areSameExtensions, ExtensionKey, getGalleryExtensionTelemetryData, getLocalExtensionTelemetryData } from 'mote/platform/extensionManagement/common/extensionManagementUtil';
import { ExtensionType, IExtensionManifest, isApplicationScopedExtension, TargetPlatform } from 'mote/platform/extensions/common/extensions';
