...
import { CancellationError, getErrorMessage, isCancellationError } from 'mote/base/common/errors';
import { IPager } from 'mote/base/common/paging';
import { isWeb, platform } from 'mote/base/common/platform';
...
import { getFallbackTargetPlarforms, getTargetPlatform, IExtensionGalleryService, IExtensionIdentifier, IExtensionInfo, IGalleryExtension, IGalleryExtensionAsset, IGalleryExtensionAssets, IGalleryExtensionVersion, InstallOperation, IQueryOptions, IExtensionsControlManifest, isNotWebExtensionInWebTargetPlatform, isTargetPlatformCompatible, ITranslation, SortBy, SortOrder, StatisticType, toTargetPlatform, WEB_EXTENSION_TAG, IExtensionQueryOptions, IDeprecationInfo } from 'mote/platform/extensionManagement/common/extensionManagement';
import { adoptToGalleryExtensionId, areSameExtensions, getGalleryExtensionId, getGalleryExtensionTelemetryData } from 'mote/platform/extensionManagement/common/extensionManagementUtil';
import { IExtensionManifest, TargetPlatform } from 'mote/platform/extensions/common/extensions';
...
import { asJson, asTextOrError, IRequestService, isSuccess } from 'mote/platform/request/common/request';
import { resolveMarketplaceHeaders } from 'mote/platform/externalServices/common/marketplace';
