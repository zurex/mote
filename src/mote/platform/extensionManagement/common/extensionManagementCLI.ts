...
import { isCancellationError } from 'mote/base/common/errors';
import { Schemas } from 'mote/base/common/network';
import { basename } from 'mote/base/common/resources';
import { gt } from 'mote/base/common/semver/semver';
import { URI } from 'mote/base/common/uri';
import { localize } from 'mote/nls';
import { CLIOutput, IExtensionGalleryService, IExtensionManagementService, IGalleryExtension, ILocalExtension, InstallOptions } from 'mote/platform/extensionManagement/common/extensionManagement';
import { areSameExtensions, getGalleryExtensionId, getIdAndVersion } from 'mote/platform/extensionManagement/common/extensionManagementUtil';
import { ExtensionType, EXTENSION_CATEGORIES, IExtensionManifest } from 'mote/platform/extensions/common/extensions';
