...
import { IStorageService, IStorageValueChangeEvent, StorageScope, StorageTarget } from 'mote/platform/storage/common/storage';
import { adoptToGalleryExtensionId, areSameExtensions, getExtensionId } from 'mote/platform/extensionManagement/common/extensionManagementUtil';
...
import { IExtension } from 'mote/platform/extensions/common/extensions';
import { isString } from 'mote/base/common/types';
import { IStringDictionary } from 'mote/base/common/collections';
import { IExtensionManagementService, IGalleryExtension } from 'mote/platform/extensionManagement/common/extensionManagement';
