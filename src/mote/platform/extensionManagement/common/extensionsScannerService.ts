...
import { getNodeType, parse, ParseError } from 'mote/base/common/json';
import { getParseErrorMessage } from 'mote/base/common/jsonErrorMessages';
...
import { basename, isEqual, joinPath } from 'mote/base/common/resources';
...
import { Metadata } from 'mote/platform/extensionManagement/common/extensionManagement';
import { areSameExtensions, computeTargetPlatform, ExtensionKey, getExtensionId, getGalleryExtensionId } from 'mote/platform/extensionManagement/common/extensionManagementUtil';
import { ExtensionType, ExtensionIdentifier, IExtensionManifest, TargetPlatform, IExtensionIdentifier, IRelaxedExtensionManifest, UNDEFINED_PUBLISHER, IExtensionDescription, BUILTIN_MANIFEST_CACHE_FILE, USER_MANIFEST_CACHE_FILE, MANIFEST_CACHE_FOLDER } from 'mote/platform/extensions/common/extensions';
import { validateExtensionManifest } from 'mote/platform/extensions/common/extensionValidator';
import { FileOperationResult, IFileService, toFileOperationResult } from 'mote/platform/files/common/files';
...
import { ExtensionsProfileScanningError, ExtensionsProfileScanningErrorCode, IExtensionsProfileScannerService, IProfileExtensionsScanOptions, IScannedProfileExtension } from 'mote/platform/extensionManagement/common/extensionsProfileScannerService';
...
import { localizeManifest } from 'mote/platform/extensionManagement/common/extensionNls';
import { ImplicitActivationEvents } from 'mote/platform/extensionManagement/common/implicitActivationEvents';
