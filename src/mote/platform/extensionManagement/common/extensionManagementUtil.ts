...
import { compareIgnoreCase } from 'mote/base/common/strings';
import { IExtensionIdentifier, IGalleryExtension, ILocalExtension, getTargetPlatform } from 'mote/platform/extensionManagement/common/extensionManagement';
import { ExtensionIdentifier, IExtension, TargetPlatform } from 'mote/platform/extensions/common/extensions';
import { IFileService } from 'mote/platform/files/common/files';
import { isLinux, platform } from 'mote/base/common/platform';
