...
import { IExecutableBasedExtensionTip, IExtensionManagementService, ILocalExtension } from 'mote/platform/extensionManagement/common/extensionManagement';
import { areSameExtensions } from 'mote/platform/extensionManagement/common/extensionManagementUtil';
import { ExtensionTipsService as BaseExtensionTipsService } from 'mote/platform/extensionManagement/common/extensionTipsService';
import { IExtensionRecommendationNotificationService, RecommendationsNotificationResult, RecommendationSource } from 'mote/platform/extensionRecommendations/common/extensionRecommendations';
import { ExtensionType } from 'mote/platform/extensions/common/extensions';
