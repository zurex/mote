...
import { IconLabel, IIconLabelValueOptions } from 'mote/base/browser/ui/iconLabel/iconLabel';
import { KeybindingLabel } from 'mote/base/browser/ui/keybindingLabel/keybindingLabel';
import { IListRenderer, IListVirtualDelegate } from 'mote/base/browser/ui/list/list';
import { IListAccessibilityProvider, IListOptions, IListStyles, List } from 'mote/base/browser/ui/list/listWidget';
import { IAction } from 'mote/base/common/actions';
import { range } from 'mote/base/common/arrays';
import { compareAnything } from 'mote/base/common/comparers';
import { memoize } from 'mote/base/common/decorators';
import { Emitter, Event } from 'mote/base/common/event';
import { IMatch } from 'mote/base/common/filters';
import { getCodiconAriaLabel, IParsedLabelWithIcons, matchesFuzzyIconAware, parseLabelWithIcons } from 'mote/base/common/iconLabels';
...
import { IQuickInputOptions } from 'mote/base/parts/quickinput/browser/quickInput';
import { getIconClass } from 'mote/base/parts/quickinput/browser/quickInputUtils';
import { QuickPickItem, IQuickPickItem, IQuickPickItemButtonEvent, IQuickPickSeparator, IQuickPickSeparatorButtonEvent } from 'mote/base/parts/quickinput/common/quickInput';
import 'mote/css!./media/quickInput';
