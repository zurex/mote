...
import { EventType, Gesture, GestureEvent } from 'mote/base/browser/touch';
import { cleanMnemonic, Direction, IMenuOptions, IMenuStyles, Menu, MENU_ESCAPED_MNEMONIC_REGEX, MENU_MNEMONIC_REGEX } from 'mote/base/browser/ui/menu/menu';
import { ActionRunner, IAction, IActionRunner, Separator, SubmenuAction } from 'mote/base/common/actions';
...
import { KeyCode, KeyMod, ScanCode, ScanCodeUtils } from 'mote/base/common/keyCodes';
