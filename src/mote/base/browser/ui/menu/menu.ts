...
import { $, addDisposableListener, append, clearNode, createStyleSheet, Dimension, EventHelper, EventLike, EventType, getActiveElement, IDomNodePagePosition, isAncestor, isInShadowDOM } from 'mote/base/browser/dom';
...
import { ActionBar, ActionsOrientation, IActionViewItemProvider } from 'mote/base/browser/ui/actionbar/actionbar';
import { ActionViewItem, BaseActionViewItem, IActionViewItemOptions } from 'mote/base/browser/ui/actionbar/actionViewItems';
import { AnchorAlignment, layout, LayoutAnchorPosition } from 'mote/base/browser/ui/contextview/contextview';
...
import { EmptySubmenuAction, IAction, IActionRunner, Separator, SubmenuAction } from 'mote/base/common/actions';
...
import { isLinux, isMacintosh } from 'mote/base/common/platform';
...
.monaco-menu .monaco-action-bar.vertical .action-label.separator {
	display: block;
	border-bottom: 1px solid var(--mote-menu-separatorBackground);
	padding-top: 1px;
	padding: 30px;
}
