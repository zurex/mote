...
import { renderFormattedText, renderText } from 'mote/base/browser/formattedTextRenderer';
import { IHistoryNavigationWidget } from 'mote/base/browser/history';
import { MarkdownRenderOptions } from 'mote/base/browser/markdownRenderer';
import { ActionBar } from 'mote/base/browser/ui/actionbar/actionbar';
import * as aria from 'mote/base/browser/ui/aria/aria';
import { AnchorAlignment, IContextViewProvider } from 'mote/base/browser/ui/contextview/contextview';
import { ScrollableElement } from 'mote/base/browser/ui/scrollbar/scrollableElement';
import { Widget } from 'mote/base/browser/ui/widget';
import { IAction } from 'mote/base/common/actions';
import { Emitter, Event } from 'mote/base/common/event';
import { HistoryNavigator } from 'mote/base/common/history';
import { ScrollbarVisibility } from 'mote/base/common/scrollable';
import 'mote/css!./inputBox';
