...
import { IMarkdownString, escapeDoubleQuotes, parseHrefAndDimensions, removeMarkdownEscapes, MarkdownStringTrustedOptions } from 'mote/base/common/htmlContent';
...
import { marked } from 'mote/base/common/marked/marked';
