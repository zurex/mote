...
import { hasDriveLetter, toSlashes } from 'mote/base/common/extpath';
import { posix, sep, win32 } from 'mote/base/common/path';
...
import { rtrim, startsWithIgnoreCase } from 'mote/base/common/strings';
