...
import { createMatches as createFuzzyMatches, fuzzyScore, IMatch, isUpper, matchesPrefix } from 'mote/base/common/filters';
...
import { equalsIgnoreCase, stripWildcards } from 'mote/base/common/strings';
